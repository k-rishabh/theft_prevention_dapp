...
contract TheftPrevention {
    ...
    constructor () {
        /* 
         * Default index mapping is 0.
         * We ensure that no phone can be mapped to the 0th index.
         */

        phones.push(Phone(0, false));
    }
     ...
     */
    function registerPhone (uint256 imei) external {
     ...
     * Check phone status.
     */
    function markStolen (uint256 imei) external {
     ...
     * Check phone status.
     */
    function markFound (uint256 imei) external {
        require(imeiToOwner[imei] == msg.sender);
    ...
    function findStolen() external view returns(Phone[] memory){
        return stolen;
    }
}

//Contract Address: 0xB25A9F4DB4aD0E1C241fe36DbE1707e084aD86ED